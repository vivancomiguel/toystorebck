...
INSERT INTO `costumer` (`first_name`,`last_name`,`email`,`avatar`, `password`,`is_active`) VALUES ('Patricio','Estrella','patricio@email.com','https://randomuser.me/api/portraits/men/30.jpg', '123', 0b1);
INSERT INTO `costumer` (`first_name`,`last_name`,`email`,`avatar`, `password`,`is_active`) VALUES ('Selena','Gómez','selena@email.com','https://randomuser.me/api/portraits/women/26.jpg', '123', 0b0);
INSERT INTO `costumer` (`first_name`,`last_name`,`email`,`avatar`, `password`,`is_active`) VALUES ('Benito','Bodoque','benito@email.com','https://randomuser.me/api/portraits/men/38.jpg', '123', 0b1);
INSERT INTO `costumer` (`first_name`,`last_name`,`email`,`avatar`, `password`,`is_active`) VALUES ('Edna','Krabappel','edna@email.com','https://randomuser.me/api/portraits/women/28.jpg', '123', 0b1);
INSERT INTO `costumer` (`first_name`,`last_name`,`email`,`avatar`, `password`,`is_active`) VALUES ('Cristiano','Ronado','cristiano@email.com','https://randomuser.me/api/portraits/men/20.jpg', '123', 0b1);
